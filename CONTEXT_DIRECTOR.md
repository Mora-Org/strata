...
├── .speckit/             [existe] specs vivas, planos, tracking
└── (sem código ainda — M1 começa o scaffolding)
```

Próximo marco: scaffolding Tauri + fork do Pi rodando "hello world" no chat. Tracking em `.speckit/plans/current.md`.
